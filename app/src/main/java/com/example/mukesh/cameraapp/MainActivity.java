package com.example.mukesh.cameraapp;
...
import com.example.mukesh.services.ClearNotificationService.ClearBinder;
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        boolean isUsed=isCameraUsebyApp();
    ...
    public void onPause() {
        ...
        mNotifyBuilder = new NotificationCompat.Builder(this)
                ...
                .setSmallIcon(R.drawable.abc_btn_check_material).setOngoing(true);
            ...
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName className,
                    ...
                    ((ClearBinder) binder).service.startService(new Intent(
                            MainActivity.this,
                            com.example.mukesh.services.ClearNotificationService.class));
                    NotificationManager mNotificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
                    mNotificationManager.notify(
                            com.example.mukesh.services.ClearNotificationService.NOTIFICATION_ID,
        ...
        if (!mIsBound) {
            bindService(new Intent(MainActivity.this,
                            com.example.mukesh.services.ClearNotificationService.class), mConnection,
    ...
    public void onResume() {
        ...
        mNotificationManager.cancel(com.example.mukesh.services.ClearNotificationService.NOTIFICATION_ID);
    ...
    public void onStop() {
        ...
        if (isFinishing()) {
            mNotificationManager
                    .cancel(com.example.mukesh.services.ClearNotificationService.NOTIFICATION_ID);
            if (mSession != null) {
                mSession.disconnect();
            }
        }
    ...
    private void sessionConnect() {
        if (mSession == null) {
            mSession = new Session(MainActivity.this,
                    com.example.mukesh.config.OpenTokConfig.API_KEY, com.example.mukesh.config.OpenTokConfig.SESSION_ID);
            mSession.setSessionListener(this);
            mSession.connect(com.example.mukesh.config.OpenTokConfig.TOKEN);
        }
    }
    ...
    public void onConnected(Session session) {
        ...
        boolean isCamUsed=  isCameraUsebyApp();
        //Start screensharing
        if (mPublisher == null) {
            ...
            com.example.mukesh.screensharing.ScreensharingCapturer screenCapturer = new com.example.mukesh.screensharing.ScreensharingCapturer(
    ...
    public void onStreamReceived(Session session, Stream stream) {
        if (!com.example.mukesh.config.OpenTokConfig.SUBSCRIBE_TO_SELF) {
            mStreams.add(stream);
            if (mSubscriber == null) {
    ...
    public void onStreamDestroyed(PublisherKit publisher, Stream stream) {
        if ((com.example.mukesh.config.OpenTokConfig.SUBSCRIBE_TO_SELF && mSubscriber != null)) {
            unsubscribeFromStream(stream);
        }
    }
